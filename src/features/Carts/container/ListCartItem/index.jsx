      ...
      {carts.length > 0 ? (
        <>
          ...
          <div className="grid grid-cols-12 gap-1 justify-items-center mb-4">
            ...
            <div className="col-span-4 font-medium justify-self-start">
              sản phẩm
            </div>
            <div className="col-span-2 font-medium justify-self-start">
              Đơn giá
            </div>
            <div className="col-span-2 font-medium">Số lượng</div>
            <div className="col-span-2 font-medium justify-self-end">
              Tổng giá
            </div>
          </div>
